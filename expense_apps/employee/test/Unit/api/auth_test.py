...
class TestAuthMiddleware:
    ...
    @allure.title("Require employee auth - no token")
    def test_require_employee_auth_no_token(self, app, client):
        @app.route('/test-auth')
    ...
    @allure.title("Require employee auth - invalid token")
    def test_require_employee_auth_invalid_token(self, app, client):
    ...
    @allure.title("Require employee auth - wrong role")
    def test_require_employee_auth_wrong_role(self, app, client):
    ...
    @allure.title("Require employee auth - success")
    def test_require_employee_auth_success(self, app, client):
